...
const ShopProduct = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-cente pb-7 ml-5">
      <div className="flex gap-5">
        <Link className="hover:text-2xl"><IoGrid/></Link>
        <Link className="hover:text-2xl"><FaList/></Link>
      </div>
      ...
      <div className="flex items-center relative ">
        ...
        <Input inType="text" inPh="36" className="border px-2 py-1"/>
        <Image src={arrow} className="h-1 absolute top-4 right-3"/>
      </div>
      </div>
    </div>
